...
GLfloat LeftCloudSpeed = 0.005f;

// Middle Cloud
GLfloat MiddleCloudPosition = 0.0f;
GLfloat MiddleCloudSpeed = 0.005f;

// Right Cloud
GLfloat RightCloudPosition = 0.0f;
GLfloat RightCloudSpeed = 0.005f;
...
void update(int value)
{
    ...
    // Left cloud
    if (LeftCloudPosition > 1.9f)
        LeftCloudPosition = -0.5f;
    LeftCloudPosition += LeftCloudSpeed;

    // Middle cloud
    if (MiddleCloudPosition > 1.2f)
        MiddleCloudPosition = -1.2f;
    MiddleCloudPosition += MiddleCloudSpeed;

    // Right cloud
    if (RightCloudPosition > 0.4f)
        RightCloudPosition = -2.0f;
